...
public interface IInvestService extends IBaseService<InvestModel> {
   ...
   * @throws Exception
   */
  void bid(long user_id, long borrow_id, long amount, AccessChannel channel) throws Exception;
   ...
   * @throws Exception
   */
  void creditorRight(long user_id, long transfer_id, int partition, AccessChannel channel) throws Exception;
