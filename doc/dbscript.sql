...
CREATE TABLE `etl_creditor_transfer` (
  ...
  `borrow_id` int(11) NOT NULL COMMENT '标的id',
  `origin_partition` int(11) NOT NULL DEFAULT '0' COMMENT '原债权份数',
  `transfer_partition` int(11) NOT NULL DEFAULT '0' COMMENT '转让份数',
  ...
  `unpaid_capital` int(11) NOT NULL DEFAULT '0' COMMENT '按转让份数计算的待回收本金（分）',
  `unpaid_interest` int(11) NOT NULL DEFAULT '0' COMMENT '按转让份数计算的待回收利息（分）',
